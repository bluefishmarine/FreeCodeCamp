// You are given a JSON object representing a 
// part of your musical album collection. 
// Each album has several properties and 
// a unique id number as its key. 
...
// and a value(like "Addicted to Love") to modify 
...
// property, create an empty array before adding the 
// new value to the album's corresponding property.

// If prop is "tracks" and value isn't empty (""), push the 
// value onto the end of the album's existing tracks array.
